...
const Section7: React.FC = () => {
  const [type, setType] = useState("marcas");
  ...
  useEffect(() => {
    if (type === "marcas") setList(brandList);
    ...
    <Container mb="70px">
      <FlexBox>
          ...
          <Box shadow={6} borderRadius={10} padding="1.25rem" bg="white">
            <FlexBox mt="-0.5rem" mb="0.5rem">
              <Typography
                ...
                color={type === "marcas" ? "gray.900" : "gray.600"}
                onClick={() => setType("marcas")}
              >
                Marcas
              </Typography>
              <Typography
              ...
              <Typography
                ...
                fontSize="20px"
                padding="0.5rem 1rem"
                color={type === "lojas" ? "gray.900" : "gray.600"}
                style={{ cursor: "pointer" }}
        ...
        <Box flex="1 1 0" minWidth="0px">
          <CategorySectionHeader title="Celulares" seeMoreLink="#" />
